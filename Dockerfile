...
#Import Gudz
RUN wget https://raw.githubusercontent.com/heshan3030/dk-userbot-TG/master/lightningrun.py
RUN wget https://raw.githubusercontent.com/heshan3030/dk-userbot-TG/master/requirements.txt
#Start Fumkin
