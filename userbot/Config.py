...
class Var(object):
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/heshan3030/dk-userbot-TG"
    )
    ALIVE_PIC = os.environ.get(
        "ALIVE_IMAGE", "https://te.legra.ph/file/f8610f27af09cdaf40589.jpg"
    )
    CUSTOM_ALIVE_PIC = os.environ.get(
        "CUSTOM_ALIVE_IMG", "https://te.legra.ph/file/f8610f27af09cdaf40589.jpg"
    )
    ALIVE_IMAGE = os.environ.get(
        "ALIVE_PIC", "https://te.legra.ph/file/f8610f27af09cdaf40589.jpg"
    )
